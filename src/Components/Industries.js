...
const Industries = () => {
    return (
        ...
        <div className="bg-[#f9f5f2] px-6 py-3 w-full mx-auto h-[400px]">
            <div className='text-center text-blue-900 text-[40px] font-bold py-20'>
                Industries
            </div>
            <div className="flex items-center space-x-2 w-[80%] mx-auto justify-between">
                <div className='border-[1px] border-b-[5px] border-blue-900 rounded-[50%] relative w-[300px] h-[100px] bg-white'>
                    <div className='border-[1px] border-b-[5px] border-blue-900 rounded-[50%] w-full h-[100px] bg-white absolute bottom-2 left-1'>
                        ...
                        <div className='absolute -top-8 left-16 z-20'>
                            <svg preserveAspectRatio="xMidYMid meet" data-bbox="20.5 22.5 159 155" viewBox="20.5 22.5 159 155" height="50" width="50" xmlns="http://www.w3.org/2000/svg" data-type="shape" role="presentation" aria-hidden="true" aria-label="" fill='#ffffff' stroke='#1C1E87' strokeWidth={5}  className="animate-scale">
                                <g>
                ...
                <div className='border-[1px] border-b-[5px] border-blue-900 rounded-[50%] relative w-[300px] h-[100px] bg-white'>
                    <div className='border-[1px] border-b-[5px] border-blue-900 rounded-[50%] w-full h-[100px] bg-white absolute bottom-2 left-1'>
                        ...
                        <div className='absolute -top-8 left-16 z-20'>
                            <svg preserveAspectRatio="xMidYMid meet" data-bbox="20 20 160 160" viewBox="20 20 160 160" height="50" width="50" xmlns="http://www.w3.org/2000/svg" data-type="shape" role="presentation" aria-hidden="true" aria-label="" fill='#ffffff' stroke='#1C1E87' strokeWidth={5} className="animate-scale">
                                <g>
